...
API_TOKEN = '7745714016:AAGpcrYVjHuhLQZ3qoDcGF7chGcZTRyVkuU'
...
async def start_bot(bot: Bot):
    await bot.send_message(6409453457,"Bot ishga tushdi !! ")

async def shutdown_bot(bot: Bot):
    await bot.send_message(6409453457,"Bot o'chdi !! ")
